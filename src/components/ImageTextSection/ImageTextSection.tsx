...
import { Grid, Row, Offset, Cell, ImageAndText, ImageAlignment } from '@matthill8286/atomic-ui'
...
export const ImageTextSection: React.FC<ImageTextSectionProps> = ({
  ...
  return <>{imageAndTextFields.map((field, index) => renderImageAndText(field, index))}</>
}
