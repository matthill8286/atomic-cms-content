...
const getChildTagName = childNode =>
  childNode.italic
    ? 'em'
    : childNode.code
    ? 'pre'
...
const renderModifier =
  (customProps: Partial<SerializerCustomProps> = {}) =>
  (node: {children: Array<NodeChild>}, childText: string) => {
...
export const ConfigurableGraphCmsHtmlSerializer =
  ...
  (render: CommonNode) => {
    const serialize = {
      renderNode: {
        ...
        [BLOCKS.TABLE_HEAD]: (node: any, children: any) => (
          <thead>{children}</thead>
        ),
        [BLOCKS.TABLE_BODY]: (node: any, children: any) => (
