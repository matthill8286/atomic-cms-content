import { Heading, Picture, styled } from '@matthill8286/atomic-ui'
...
export const NewsImageStyled = styled(Picture)``

export const NewsHeadingStyled = styled(Heading)``

export const NewsDateStyled = styled(Heading)``

export const NewsPostLargeStyled = styled(Heading)``
