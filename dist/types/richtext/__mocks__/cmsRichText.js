export var rawMockBulletedListWithChildren = {
  children: [{
    type: 'paragraph',
    children: [{
    ...
    children: [{
      ...
      children: [{
        type: 'list-item-child',
        children: [{
          text: 'We only collect and process your data for the purposes set out in this Privacy Statement or for specific purposes that we share with you and/or that you have consented to'
        }]
      }]
    }, {
      type: 'list-item',
      ...
      children: [{
        type: 'list-item-child',
        children: [{
          text: 'When we do collect your personal data, we aim to keep it as accurate and up to date as possible.'
        }]
      }]
    }, {
      type: 'list-item',
      children: [{
        type: 'list-item-child',
        children: [{
          text: 'If the personal data we collect is no longer needed for any purposes and we are not required by law to retain it, we will do what we can to delete, destroy or permanently de-identify it.'
        }]
      }]
    }, {
      type: 'list-item',
      children: [{
        type: 'list-item-child',
        children: [{
          text: 'Your personal data will not be shared, sold, rented or disclosed other than as described in this Privacy Statement.'
        }]
      }]
    }]
  }]
};
export var mockRawWithBoldAndUnderline = {
  raw: {
    children: [{
      type: 'paragraph',
      children: [{
        ...
        text: ' data we hold, to manage your personal data in a responsible way and to be transparent in our practices. Your trust is important to us.'
      }, {
...
//# sourceMappingURL=cmsRichText.js.map